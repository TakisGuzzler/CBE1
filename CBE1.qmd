...
Most interesting is the difference between the three career politician candidates - Obama, Romney, and Harris - and the non career politician candidate - Trump. Trump appears far more willing to use negative language. Beyond this difference, the sentiment of the candidates language is more so informed by the time period than it is by their party as can be seen in the lack of overlap across years and within parties in the Keyness tables. Even though Harris has an overall less negative sentiment when compared to Trump, the two are more negative than their party predecessors - Romney and Obama. This could be due to the change in politics over the time period. Ultimately, we did not find any connection between parties and the sentiment expressed by the candidates. However, the slightly more negative average emotional valence expressed by the Republic candidates could be attributed to the fact that they were not the incumbents.

In 2012, both all participants had fluctuating emotional valences that were somewhat aligned, suggesting they might be having a more dynamic interaction with the moderator and each other. In contrast, the 2024 debate saw Trump experience a decline in emotional valence followed by an increase until the end of the debate. Harris displayed similar fluctuations, along with similar trends for the moderators. This change in emotional valence sheds light on the changing nature of political debates and could reflect candidate strategies or shifting voter expectations.
