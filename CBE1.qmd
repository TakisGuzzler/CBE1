...
```{r, fig.cap="Emotional Valence vs. Time for the 2012 Debate Participants"}
par(mfrow = c(1, 3))
...
```{r fig.cap="Emotional Valence vs. Time for the 2024 Debate Participants"}
par(mfrow = c(1, 3))
